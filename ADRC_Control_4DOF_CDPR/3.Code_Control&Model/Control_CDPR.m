function CDPR = Control_CDPR(t1,v)
...
q1d=-3.994*sin(0.1796*t1 - 2.995) - 4.244*sin(0.5746*t1 + 0.1555);
q4d=19.81*sin(0.002025*t1 + 2.993) + 5.099*sin(0.5257*t1 - 0.6065);
q3d=-18.34*sin(0.002452*t1 + 0.1331) - 5.084*sin(0.5268*t1 - 2.588);
q2d=4.038*sin(0.1823*t1 + 0.1823) + 4.202*sin(0.5769*t1 + 2.34);

dq1d= -2.721*sin(0.525*t1 + 2.124);
dq4d=2.724*sin(0.5233*t1 + 0.9912);
dq3d=-2.727*sin(0.5209*t1 - 0.9968);
dq2d=2.722*sin(0.5277*t1 - 2.18);
...
Kd=diag([wd,wd,wd,wd]);
Kp=diag([wp,wp,wp,wp]);
ut=(Im*(ddqd+Kd*(dqd-dq)+Kp*(qd-q))+D);
